...
use Illuminate\Support\Facades\{Artisan,Cache,DB,Redis};

class CacheFunctionsCard extends Component
{
    ...
    {
        return view('vuexy-admin::livewire.tools.cache.cache-functions-card');
    }
}
