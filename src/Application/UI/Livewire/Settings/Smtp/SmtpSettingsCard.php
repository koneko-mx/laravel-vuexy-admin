...
namespace Koneko\VuexyAdmin\Application\UI\Livewire\Settings\Smtp;

use Livewire\Component;
use Illuminate\Support\Facades\{Config,Crypt};
use Symfony\Component\Mailer\{Transport,Mailer};
use Symfony\Component\Mime\Email;

class SmtpSettingsCard extends Component
{
    private $targetNotify = "#smtp-settings-card .notification-container";
    ...
    {
        return view('vuexy-admin::livewire.settings.smtp.smtp-settings-card');
    }
}
