...
use Koneko\VuexyAdmin\Application\Cache\Builders\KonekoVuexyCustomizerVarsBuilder;
...
class VuexyInterfaceIndex extends Component
{
    ...
    public function clearCustomConfig()
    {
        ...
        app(KonekoVuexyCustomizerVarsBuilder::class)->clear();
    ...
    public function loadForm()
    {
        ...
        $settings = app(KonekoVuexyCustomizerVarsBuilder::class)->get();
dump($settings);
